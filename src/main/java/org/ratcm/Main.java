...
public class Main {
    ...
    public static void addInventory() {
	    //Read in amt coffee
	    int coffeeInt =  parseQuantity(inputOutput("\nPlease enter the units of coffee to add: "));
	    	    
	    //Read in amt milk
	    int milkInt =  parseQuantity(inputOutput("\nPlease enter the units of milk to add: "));
	    	    
	    //Read in amt sugar
	    int sugarInt = parseQuantity(inputOutput("\nPlease enter the units of sugar to add: "));
	    	    
	    //Read in amt chocolate
	    int chocolateInt =  parseQuantity(inputOutput("\nPlease enter the units of chocolate to add: "));
	    	    
        try {
        	coffeeMaker.addInventory(coffeeInt, milkInt, sugarInt, chocolateInt);
